...
export default function FilterPanel() {
  ...
  return (
    <div className="bg-white p-5 rounded-lg shadow-sm max-w-lg mx-auto">
      {/* العنوان + Clear All */}
      ...
      <div className="mb-6">
        <label className="block text-sm  font-medium text-gray-700 mb-2">Your Budget For Per Night</label>
