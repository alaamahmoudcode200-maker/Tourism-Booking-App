  ...
  const testimonials: Testimonial[] = [
    {
      ...
      name: 'Sara Mohamed',
      location: 'Jakarta',
      text: "I ve been using the hotel booking system for several years now, and its become my go-to platform for planning my trips. The interface is user-friendly, and I appreciate the detailed information and real-time availability of hotels.",
    ...
    },
    {
      ...
      name: 'Lina Carter',
      location: 'London',
      text: "Ive been using the hotel booking system for several years now, and its become my go-to platform for planning my trips. The interface is user-friendly, and I appreciate the detailed information and real-time availability of hotels.",
