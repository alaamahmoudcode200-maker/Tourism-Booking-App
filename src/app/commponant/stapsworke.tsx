...
const steps = [
	...
	},
	{
		...
		title: "Book a Ticket",
		text:
			"Choose reputable platforms or book directly. Read reviews and understand cancellation policies.",
		variant: "mint",
	},
	{
		id: 3,
		...
		title: "Pay and Go",
		text:
			"Ensure secure transactions. Save and print confirmation emails. Consider travel insurance for unforeseen events.",
		variant: "blue",
	},
];

const variantBg = {
	pink: "bg-[#ff7eb3]/20", // شفاف للخلفية
	mint: "bg-[#42e6c0]/20",
	blue: "bg-[#6a8cff]/20",
};

const variantAccent = {
	pink: "bg-[#ff7eb3]", // قوي للأيقونة والبار
	mint: "bg-[#42e6c0]",
	blue: "bg-[#6a8cff]",
};
							...
							<div className="">
								...
								<div className="-mt-6 sm:-mt-8 flex justify-center">
									<img
										src="/mog.png"
										alt="girl"
										className="w-2/3 h-1/2 object-cover"
									/>
								</div>
							</div>
						</div>
